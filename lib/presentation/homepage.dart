...
import 'package:wheather_app/widgets/buildSevenDayForecast.dart';
import 'package:wheather_app/widgets/buildForecastToday.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    String cityName = "england"; //city name
    int currTemp = 27; // current temperature
    int maxTemp = 35; // today max temperature
    int minTemp = 1; // today min temperature
